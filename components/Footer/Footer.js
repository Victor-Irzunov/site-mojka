...
export default function Footer() {
	return (
		<footer className="footer footer-center py-10 sd:px-10 xz:px-0 bg-[#200F40] text-primary-content" id='contacts'>
			<aside>
				<Image src='/svg/phone.svg' alt='Телефон' width={50} height={50} />

				<div className='mt-6 flex sd:flex-row xz:flex-col-reverse xz:items-center'>
					<a href='tel:80' className="font-bold sd:text-3xl xz:text-2xl mr-2">
						+375 29 000-00-00
					</a>
					<Image src='/svg/a1.svg' alt='Оператор А1 для записи на автомойку' width={25} height={25} />
				</div>

				<div className='mt-4 flex sd:flex-row xz:flex-col-reverse xz:items-center sd:pl-14 xz:pl-0'>
					<a href='tel:8033' className="font-bold sd:text-3xl xz:text-2xl mr-2">
						+375 33 000-00-00
					</a>
					<Image src='/svg/mts.svg' alt='Оператор МТС для записи на автомойку' width={80} height={80} />
				</div>


				<div className='my-6 text-center'>
					<Image src='/svg/location.svg' alt='Адрес автомойки' width={50} height={50} className='mx-auto' />
					<p className='mt-4 sd:text-3xl xz:text-xl'>
						Минск, ул. Независимости 1000
					</p>
				</div>

				<Image src='/svg/time.svg' alt='Режим работы' width={50} height={50} />
				<p className='mt-0 text-2xl'>
					8:00-22:00 <span className='block text-lg font-light'>
						Без выходных
					</span>
				</p>
			...
			{/* <nav>
				<div className="flex justify-center items-center">
					...
					<a href='https://t.me/' className='mx-2.5 top-0.5 lg:tooltip' data-tip="telegram">
						<svg t="1698336845020" className="fill-current" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6173" width="33" height="33"><path d="M679.424 746.861714l84.004571-395.995428c7.424-34.852571-12.580571-48.566857-35.437714-40.009143l-493.714286 190.281143c-33.718857 13.129143-33.133714 32-5.705142 40.557714l126.281142 39.424 293.156572-184.576c13.714286-9.142857 26.294857-3.986286 16.018286 5.156571l-237.129143 214.272-9.142857 130.304c13.129143 0 18.870857-5.705143 25.709714-12.580571l61.696-59.428571 128 94.281142c23.442286 13.129143 40.009143 6.290286 46.299428-21.723428zM1024 512c0 282.843429-229.156571 512-512 512S0 794.843429 0 512 229.156571 0 512 0s512 229.156571 512 512z" p-id="6174"></path></svg>
					</a>
				</div>
			</nav> */}
			<Icon />

			<iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A45a78eb8c872957f2fcd5ffd27e1a743d61b55c328163dcd26e71342ecf36b6e&amp;source=constructor" width="100%" height="400" frameBorder="0"></iframe>

			<aside className="border-t pt-1">
				<div className='container mx-auto text-center sd:pb-20 xz:pb-16'>
